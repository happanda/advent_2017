...
const std::string input_04 = std::string(R"(nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
...
template <>
void runFix<4, 0>(int argc, char* argv[])
{
	int numGoodPhrases = 0;

	std::istringstream iss(input_04);
	std::string line;
	...
	std::cout << numGoodPhrases << std::endl;
}

template <>
void runFix<4, 1>(int argc, char* argv[])
{
	int numGoodPhrases = 0;
