...
template <>
void runFix<9, 0>(int argc, char* argv[])
{
	StateMachine machine;

	std::string const line = input_09;
	...
	std::cout << machine.getGroupSum() << std::endl;
}

template <>
void runFix<9, 1>(int argc, char* argv[])
{
	StateMachine machine;
	...
	std::cout << machine.getGarbageCount() << std::endl;
}
